...
{{/*
Names for credentials generated once per Helm release. These names deliberately
use Release.Name so parent and vendored subcharts can resolve the same Secrets.
*/}}
{{- define "dify.runtimeCredentialsSecretName" -}}
{{- printf "%s-dify-runtime-credentials" .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- end }}

{{- define "dify.postgresqlCredentialsSecretName" -}}
{{- printf "%s-dify-postgresql-credentials" .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- end }}

{{- define "dify.redisCredentialsSecretName" -}}
{{- printf "%s-dify-redis-credentials" .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- end }}

{{- define "dify.qdrantCredentialsSecretName" -}}
{{- printf "%s-dify-qdrant-credentials" .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- end }}
